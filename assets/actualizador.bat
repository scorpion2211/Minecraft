...
if exist MODSVAR.$$$ goto No
    ...
    if exist SHADERS.$$$ goto No
        ...
        git clone https://github.com/scorpion2211/minecraft-shaders.git
        cls
        echo Finalizando....
        echo.
        echo.
        xcopy "%~d0%~p0\minecraft-shaders\shaderpacks\*.*" "%userprofile%\AppData\Roaming\.minecraft\shaderpacks\" /y
	    rd /s /q "%~d0%~p0\minecraft-shaders" /s
        cls
    goto Fin
    :No
        del SHADERS.$$$
